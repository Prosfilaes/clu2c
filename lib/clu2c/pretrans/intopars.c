...
/* depend,int_oct_parse*/

#include <clu2c.h>

/* begin module */
/* c_function_name, AFint__oct__parse */
/* clu_operation_name, int_oct_parse */
int AFint__oct__parse(LVs)
     object LVs;
{
  object LVstart= 0;
  object LVsign= 0;
	  ...
	  LVi = t1;
	    {
	      ...
	      t3 = OMchar_Dge(LVc, '0');
	      if (OMbool_Dand(t3, OMchar_Dle(LVc, '7')))
	        {
		  t4 = OMchar_Dc2i(LVc);
