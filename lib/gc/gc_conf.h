/* This file has been modified by Department of Mathematical and
   ...
   $Id: gc_conf.h,v 2.0 1996/06/10 08:58:57 ushijima Exp $ */
...
#   define I386
#   ifndef DJGPP
#     define DJGPP 1	/* MSDOS running the DJGPP port of GCC */
#   else
#     /* DJGPP Version 2.xx automatically defines `DJGPP' to 2 */
#   endif
#   define mach_type_known
# endif
...
# if defined(sony_news) && (defined(mc68000) || defined(mc68020))
#   define M68K
#   define NEWSOS4
#   define mach_type_known
# endif
...
#   endif
#   ifdef NEWSOS4
#	define OS_TYPE "NEWSOS4"
	extern char etext;
#	define DATASTART ((ptr_t)((word) (&etext)))
#	define HEURISTIC2
#   endif
# endif
...
#	define OS_TYPE "NEWSOS4"
#	undef HEURISTIC2
#	define STACKBOTTOM ((ptr_t) 0x7fffe000)
#   endif
# endif
